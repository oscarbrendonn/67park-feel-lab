...
export function createCandyVehicle110({id='main-mint',color='#8ebfb5',kind='car'}={}){
 ...
 if(bus&&typeof document!=='undefined'){
  ...
  ctx.fillStyle='#ded7c8';ctx.fillRect(0,0,512,96);ctx.fillStyle='#655d4d';ctx.textAlign='center';ctx.textBaseline='middle';ctx.font='bold 39px system-ui';ctx.fillText('OKUL SERVİSİ',256,48);
