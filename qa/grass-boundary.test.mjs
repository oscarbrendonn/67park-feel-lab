...
test('published loader runs the contour repair before the final terrain sampler',()=>{
 ...
 assert(main.includes('runtime.bundle.js?v=house-roofs-1'));
 assert(fs.readFileSync(new URL('../index.html',import.meta.url),'utf8').includes('app/main.js?v=house-roofs-1'));
});
