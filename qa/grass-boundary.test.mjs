...
test('published loader runs the contour repair before the final terrain sampler',()=>{
 ...
 assert(main.includes('runtime.bundle.js?v=grass-boundary-1'));
 assert(fs.readFileSync(new URL('../index.html',import.meta.url),'utf8').includes('app/main.js?v=grass-boundary-1'));
});
