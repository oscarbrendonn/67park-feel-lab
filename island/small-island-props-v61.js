...
export async function loadSmallIslandProps({scene,renderer,sample,variant}){
 ...
 const [houseGltf,foliageGltf,layout]=await Promise.all([
  new GLTFLoader().loadAsync('/67park-feel-lab/island/small-island-houses-v61.glb?v=houses1'),
  new GLTFLoader().loadAsync('/67park-feel-lab/island/small-island-props-v45.glb?v=round1'),
